...
let clicks2DescTxt = 'Getting up there in clicks.';
...
let focus3BonusTxt = '+3 to focus every time the bar fills.';
let focus4BonusTxt = '+4 to focus every time the bar fills.';
let focus5BonusTxt = 'Focus gained from a bar fill is doubled.';
let playedBonusTxt1 = 'Tick speed increased by 1%';
let playedBonusTxt2 = 'Tick speed increased by an additional 2%';
let playedBonusTxt3 = 'Tick speed increased by an additional by 3%';
let playedBonusTxt4 = 'Tick speed increased by an additional by 4%';
let playedBonusTxt5 = 'Tick speed increased by an additional by 10%';
